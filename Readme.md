...
> 3:56: Встал в 13:00  
> Мало что учил(работа с DOM), порешал задачи по циклам, готовлюсь покупать подарки родственикам т.к. черная пятница  
...
> 3:09: Встал в 13:00  
> `Обучение JavaScript идет в хорошем темпе`, я уже хорошо понимаю, циклы, условия решил сегодня много задач на эту тему, завтра еще закреплю  
> Завтра буду учиться работать с DOM и массивами, наконец-то вижу результат.  
> Подумываю над созданием `отдельного репозитория` для обучения `Js` что-бы не перегружать этот лишней белебердой с практикой.  
...
> 3:00: Встал в 12:30  
> Многое сегодня научился делать, `работа с DOM в JavaScript`, многое повторил.
> По идее, я уже `могу продолжить работу` непосредственно `над` самим `проектом`, так как я уже понял как можно это сделать, `но я продолжу обучение`, чтобы лучше узнать, JavaScript.
...
> 3:35: Встал в 12:30  
> Мало чего узнал(масивы), много чего повторил(объекты, функции, условия), мало мотивации когда не видишь результата, но я стараюсь учиться  
> Хочу сделать какойнибудь мини проект типа игры, пока точно не решил, что именно  
> Надо еще многое разобрать, больше писать нечего.  
...
> 3:05: Встал в 13:00  
> Что я сегодня узнал? наверное почти не чего. Закрепил имеющиеся знания `разобрал рекурсии и замыкания у функций`(да да все теже функции)  
> Начал изучать объекты, вроде пока все понятно, хотелось бы `сделать`, что-то `интересное`, чтобы `закрепить знания`.  
> Однако как я помню(при изучении css и html) вся теория все равно вылетит из моей головы, и закрепить материал по настоящему можно только делая какой-то проект.  
> Мой проект с сайтом TOXIN уже запылился, хочется уже приступить к работе над его завершением  
...
> 0:54: Встал в 11:50  
> Сегодня я вроде бы преодолел гору под названием функция. На самом деле для меня эта тема давалась очень тяжело, и я пока не до конца понял все тонкости  
> `Начал изучать объекты`, стараюсь не изучать все сильно глубоко, но это редко удаётся.  
> В последнее время мало коммитов, но я не вижу в них смысла т.к. я не чего не верстаю, а просто заполню дневник  
...
> Однако я немного поверстал, `слелал checkbox` мне даже самому понравилось.  
> А с Js я сегодня только повторял, посмотрел как вообще применяют скрипты в практике  
> Для общего развития `узнал`: что такое `ООП` и почему столько разговоров о нем, как оптимизировть картинки и что такое `framework в целом`.  
...
> #### 21.11.2019
> 23:50: Встал в 12:00  
> `Перешел на вечерний режим`, так как, ночью все спят и меня никто не отвлекает  
> Сегодня решил много интересных задач, а над некоторыми до сих пор ломаю голову.  
> Книга `"Выразительный JavaScript"` понравилась мне всех больше она без воды, и с интересными задачами  
> Теперь `буду заполнять дневник поздно вечером`
...
> #### 20.11.2019
> 23:00: Встал в 7:30  
> `Хороший продвиг на JS`, нашел хороший курс.  
> Решил, что все таки `ночной режим` мне был `удобнее`, я скорее всего вернусь к нему, мне кажется я больше учил и успевал, т.к. меня не кто не отвлекал  
> Сегодня взлянул на макет свежим взглядом, посмотрел видео про checkbox, и я не пойму, почему я решил что без JavaScript я не смогу их сделать?  
> Во всяком продолжу изучать js когда от информации будет кипеть голова, буду верстать  
...
> #### 19.11.2019
> 21:00: Встал в 7:30  
> Изучил много начальной теории, решил интересную задачу с выводом градусов между минутной и часовой стрелкой  
> Пока не очень понимаю, как мне поможет js делать то что я хочу, но понимаю, что скоро всё узнаю  
> Время бежит очень быстро и я уже хочу продолжить работать над проектом  
> Очень много сухой информации или наоборот воды.  
...
> #### 18.11.2019
> 21:00: Встал в 7:30  
> Прошел всю главу `Качество кода`(там нет практики) повторил условия, циклы и функции  
> Сегодня услышал много непонятных слов, часто отвекался на них, потом они вылетали и я опять google'ил  
> Читаю две книги на одну тему с отставанием на два дня. Так я повторяю материал который мог забыть когда проходил  
...
> #### 17.11.2019
> 21:00: Встал в 8:00  
> Немного проспал, но занимался сегодня хорошо, разобрал что такой функции, но думаю надо все время повторять иначе на следующий день из головы все вылетает  
> В learn javascript уже начал другую главу, разбирать каждую тему по отдельности. Помимо этого я смотю много курсов.  
...
> #### 16.11.2019
> 21:00: Встал в 7:30  
> Создал план учебы в Trello чтобы все было по плану  
> Прошел функции, хотя должен был пройти главу, значит отстаю по плану учебы  
> Довольно сложно все запомнить
...
> #### 15.11.2019
> 21:00: Встал в 7:10  
> `Циклы, циклы, циклы` очень сложно, но как я понимаю это основа JavaScript, поэтому надо хорошо изучать эту тему  
> Также сделал файл `app.js своим практикумом`. буду решать в нем задачи по Js  
> Почитал сегодня пару книг пока не знаю что сказать, думаю надо составить `расписание занятий обучения в Trello`  
...
> #### 14.11.2019
> 21:00: Встал в 7:10  
> Каждый раз отчет в 14:00 и 21:00 я писать забываю, т.к. сильно погружен в изучение.  
> Буду писать один раз в день, и особенно если будет какой-то прорыв в обучение.  
> Обучаюсь по learn javascript. Подача материала понравилась больше всего  
...
> #### 13.11.2019
> 14:00: Встал в 7:10  
> Подкорректировал план учебы, нашел много хороших ресурсов, `две книги`, `два YouTube канала`, и очень классную `лекцию от гарварда`, переведенную на русский язык JavaRush(уже полностью посмотрел)  
> Я все записываю в тетрадь, узнал какие типы данных есть в Js, с помощью чего создаються переменные, как и где работают скрипты.  
> С лекции по гарварду узнал как работает интернет, в частности HTTP, firewall, прокси, как все это работает и прочее  
